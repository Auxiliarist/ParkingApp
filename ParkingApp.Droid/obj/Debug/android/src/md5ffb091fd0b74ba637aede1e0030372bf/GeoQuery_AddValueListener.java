...
public class GeoQuery_AddValueListener
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("GeoFire.Xamarin.Android.GeoQuery+AddValueListener, GeoFire.Xamarin.Android", GeoQuery_AddValueListener.class, __md_methods);
	}


	public GeoQuery_AddValueListener ()
	{
		super ();
		if (getClass () == GeoQuery_AddValueListener.class)
			mono.android.TypeManager.Activate ("GeoFire.Xamarin.Android.GeoQuery+AddValueListener, GeoFire.Xamarin.Android", "", this, new java.lang.Object[] {  });
	}
